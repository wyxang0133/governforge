...
class AppSettings(BaseSettings):
    ...
    service_name: str = "governforge-api"
    cors_origins: str = "http://localhost:3000"
    # Compatibility default for pre-rename local PostgreSQL volumes; production always overrides it.
    ...
    otel_service_name: str = "governforge-api"
