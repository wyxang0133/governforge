...
type Repository = { id: string; full_name: string; provider: string; default_branch: string; installation_id?: string; active: boolean; html_url?: string };
